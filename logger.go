...
/* func main() {					// Driver main.. this function is not to be used with its own main and is rather an extenstion 
							// to log files for servers.. However this main can be used to test the code.

 	s := "This message will be logged"

 	path := os.Getenv("FOO")			// I would suggest using environment variables instead of absolute paths
